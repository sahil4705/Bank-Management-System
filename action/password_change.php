...
if (isset($_POST['change'])) {
    $res = mysqli_query($con, "SELECT * FROM user_login WHERE username = '$username' AND password = '$opassword' ");
    if (!mysqli_num_rows($res) > 0) {
        ...
        @$npassword = $_POST['npassword'];
        $sql = "UPDATE user_login SET password = '$npassword' , cpassword = '$npassword'  WHERE username = '$username' ";
